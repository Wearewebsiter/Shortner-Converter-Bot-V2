...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "6030644949:AAHXEt_cX0d3REE2Ru-mYMXxVI2WNocpP4E")
...
#  Optionnal variables
LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1001952868714")) 
UPDATE_CHANNEL = os.environ.get("UPDATE_CHANNEL", "channelhubs") # For Force Subscription
